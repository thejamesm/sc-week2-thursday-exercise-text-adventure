...
class Room:
    ...
    @locked.setter
    def locked(self, lock_status) -> None:
    ...
    @character.setter
    def character(self, new_character) -> None:
        self.__character = new_character

    def lock(self, key_item) -> None:
        self.locked = True
        self.key = key_item

    def unlock(self, key_item) -> bool:
    ...
    def link_room(self, room_to_link, direction) -> None:
    ...
    def two_way_link(self, room_to_link, direction) -> None:
